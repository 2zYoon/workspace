...
CONSUMABLE_TYLENOL = 0
CONSUMABLE_MORPHINE = 1
CONSUMABLE_ELIXIR = 2
CONSUMABLE_SOJU = 3
CONSUMABLE_UNKNOWN_DRUG = 4
CONSUMABLE_HONGSAM = 5
CONSUMABLE_MATH_TEXTBOOK = 6
CONSUMABLE_NATURE = 7
CONSUMABLE_ANAVAR = 8
CONSUMABLE_WHEY = 9

ITEM_INFO = [
   ["Key #1", "Key for somewhere"],
...
CONSUMABLE_INFO = [
   ["Tylenol", "Acetaminophen. Recover 50 HP. Can use on battle."],
   ["Morphine", "An effective painkiller. Recover 350 HP. Can use on battle."],
   ["Elixir", "Get 3 STRENGTH, 3 INTELLIGENCE, 3 CHARM permanently."],
   ["Soju", "Korean alcoholic beverage. Get 2 STRENGTH and lost 1 INTELLIGENCE permanently. Required 10 INTELLIGENCE to use."],
   ["Unknown drug", "No one knows what will happen... Required 30 INT, 50 STR to use."],
   ["Hongsam", "a.k.a. Korean ginseng. Get 1 STRENGTH permanently."],
   ["Math Textbook", "Includes basic calculus and linear algebra. Get 1 INTELLIGENCE permanently."],
   ["NATURE", "World's leading science journal. Get 4 INTELLIGENCE permanently. Required 70 INTELLIGENT to use."],
   ["Anavar", "A steroid tablet. Required 50 STR to use."],
   ["Whey", "A protein powder. Get 2 STRENGTH permanently. Be cautious of lactose."],
]
...
BATTLE_INFO = [
   ["John Nace", 0,
      100, 25, 0,
      [1000, ITEM_TOILET_TISSUE, 1, CONSUMABLE_HONGSAM, 1, ITEM_NONE, 0, CONSUMABLE_NONE, 0], 
